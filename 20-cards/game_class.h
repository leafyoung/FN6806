...
inline ostream& operator<<(ostream& os, const Card::Suit& suit) {
...
class Game {
 ...
 public:
  ...
  static bool is_serial(vector<Card> cards, size_t card_max = 13) {
