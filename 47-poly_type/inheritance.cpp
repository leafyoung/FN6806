...
void test_inheritance() {
  cout << "Call from inheritance/reference" << endl;
  ...
  cout << "Call from inheritance/pointer" << endl;
  ...
  */
  ...
  cout << "Call from inheritance/template" << endl;
  operateVehicle(getVehicle("car"s));

  cout << "Return from virtual method" << endl;
  auto &r1 = vp1->self();
  r1.drive();
  Vehicle &v = vp1->self();
  v.drive();
